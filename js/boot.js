...
window.addEventListener('DOMContentLoaded', () => {
  // Wire app controls. Map will be created after app is visible.
  initList();
  initFilters();
  ...
  startBtn.addEventListener('click', async () => {
    try{
      ...
      // Switch view first so #map has a size
      home.style.display = 'none';
      app.style.display = '';

      // Now create the Leaflet map in the visible container
      initMap();
      ...
      alert('Erreur au démarrage. Ouvre la console.');
    }
  });
